  ...
  <div className="container mx-auto flex items-center justify-between p-4 md:px-6">
    ...
    <Link to="/" className="flex items-center">
      <img
        src={Logo}
        alt="Company Logo"
        className={`h-14  w-auto transition-all duration-300 ease-in-out ${isScrolled ? 'bg-white' : 'bg-transparent'}`}
      /> 
    </Link>
    ...
    <ul className="hidden md:flex space-x-8 items-center">
      <li>
        <Link
          to="/"
          className={`text-lg py-2 px-4 hover:${isScrolled ? "bg-gray-700" : "text-blue-500"} rounded-lg transition duration-300 ease-in-out ${isActiveLink("/")}`}
        >
          Home
        </Link>
      </li>
      ...
      >
        <span
          className={`block text-lg py-2 px-4 hover:bg-gray-400 rounded-lg cursor-pointer transition duration-300 ease-in-out ${isActiveLink("/services")}`}
        >
          Services
        </span>
        {/* Services Dropdown */}
      ...
      <li>
        <Link
          to="/booking"
          className={`text-lg py-2 px-4 hover:bg-gray-400 rounded-lg transition duration-300 ease-in-out ${isActiveLink("/booking")}`}
        >
          Booking
        </Link>
      </li>
      ...
      <li>
        <Link
          to="/contact"
          className={`text-lg py-2 px-4 hover:bg-gray-400 rounded-lg transition duration-300 ease-in-out ${isActiveLink("/contact")}`}
        >
          Contact
        </Link>
      </li>
